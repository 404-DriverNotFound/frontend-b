...
const dummyUserListItem: MemberType = {
  ...
  avatar: '',
  status: 'ONLINE',
  memberships: [{ role: 'MEMBER', createdAt: new Date(), unmutedAt: null }],
};
    ...
    <List scroll height="70vh">
      <ChannelUserListItem
        info={{
          ...dummyUserListItem,
          name: 'MutedMember',
          memberships: [{ role: 'MEMBER', createdAt: new Date(), unmutedAt: new Date() }],
        }}
        myRole="OWNER"
      />
      <ChannelUserListItem
        info={{
          ...
          name: 'BannedMember',
          status: 'IN_GAME',
          memberships: [{ role: 'BANNED', createdAt: new Date(), unmutedAt: new Date() }],
        }}
        myRole="OWNER"
      />
      <ChannelUserListItem
      ...
      <ChannelUserListItem
        info={{
          ...dummyUserListItem,
          name: 'I am Admin',
          memberships: [{ role: 'ADMIN', createdAt: new Date(), unmutedAt: new Date() }],
        }}
        myRole="OWNER"
      />
      <ChannelUserListItem
    ...
    <List scroll height="70vh">
      ...
      <ChannelUserListItem
        info={{
          ...dummyUserListItem,
          name: 'I am OWNER',
          memberships: [{ role: 'OWNER', createdAt: new Date(), unmutedAt: new Date() }],
        }}
        myRole="ADMIN"
      />
      <ChannelUserListItem
